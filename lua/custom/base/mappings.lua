...
M.custom = {
  ...
  n = {
    ...
    ["H"] = { "<CMD>vertical resize +5<CR>", "resize vertical split", opts = { noremap = true, silent = true } },
    ["L"] = { "<CMD>vertical resize -5<CR>", "resize vertical split", opts = { noremap = true, silent = true } },
    ["K"] = { "<CMD>resize +5<CR>", "resize horizontal split", opts = { noremap = true, silent = true } },
    ["J"] = { "<CMD>resize -5<CR>", "resize horizontal split", opts = { noremap = true, silent = true } },
